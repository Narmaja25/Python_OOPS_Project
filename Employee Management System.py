...
#8 Department Transfer Employee 
...
class EmployeeManagementSystem:
    ...
    def generate_employee_id(self):
        """Generate the next ID in the format EMP0001."""
        highest_number = 0
            ...
            with open(self.FILE_NAME, "r", newline="", encoding="utf-8") as file:
                for row in csv.DictReader(file):
                    ...
                    if employee_id.startswith("EMP") and employee_id[3:].isdigit():
                        highest_number = max(highest_number, int(employee_id[3:]))

        return f"EMP{highest_number + 1:04d}"
    ...
    def add_employee(self):
        ...
        is_new_file = (
            ...
            or os.path.getsize(self.FILE_NAME) == 0
        )
    ...
    def view_employee_history(self):
        ...
        print("----------------------------------------")
        with open(
            self.HISTORY_FILE_NAME, "r", newline="", encoding="utf-8"
        ) as file:
            for row in csv.DictReader(file):
                if row["employee_id"] == employee_id:
                    records_found = True
...
def main():
    ...
    while True:
        ...
        print("8. Department Transfer Employee")
